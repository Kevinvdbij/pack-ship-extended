...
onMounted(() => {
	...
	// cloak off; `afterPaint` is what makes the difference between a card that
	// exists and a card that has been painted. A navigation started before the
	// paint is a navigation the operator sees as more white screen -- and on a
	// page nobody is looking at, it is what makes sure there is no wait at all.
