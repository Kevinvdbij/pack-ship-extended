...
(function() {
	...
	_css(" .pse-modal[data-v-66d77727]{z-index:100;background-color:var(--pse-scrim);-webkit-backdrop-filter:blur(3px);text-align:left;color:var(--pse-ink);justify-content:center;align-items:center;padding:28px 20px;display:flex;position:fixed;inset:0}.pse-modal[data-v-66d77727] *{box-sizing:border-box}.is-elevated[data-v-66d77727]{z-index:200}.pse-modal-panel[data-v-66d77727]{box-sizing:border-box;border-radius:var(--pse-dialog-radius);width:100%;max-height:100%;box-shadow:var(--pse-dialog-shadow);background-color:#fff;flex-direction:column;display:flex}.is-sm[data-v-66d77727]{max-width:420px}.is-md[data-v-66d77727]{max-width:560px}.is-lg[data-v-66d77727]{max-width:780px}.is-xl[data-v-66d77727]{max-width:1000px}.pse-modal-head[data-v-66d77727]{border-bottom:1px solid var(--pse-line);flex:none;align-items:center;gap:16px;padding:17px 20px;display:flex}.pse-modal-title[data-v-66d77727]{min-width:0;color:var(--pse-ink);flex:1;margin:0;font-size:16px;font-weight:650;line-height:1.3}.pse-modal-close[data-v-66d77727]{width:32px;height:32px;color:var(--pse-ink-faint);cursor:pointer;background-color:#0000;border:0;border-radius:9px;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .15s,color .15s;display:flex}.pse-modal-close[data-v-66d77727]:hover{background-color:var(--pse-well);color:var(--pse-ink)}.pse-modal-close[data-v-66d77727]:focus{outline:none}.pse-modal-close[data-v-66d77727]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-modal-body[data-v-66d77727]{flex:1;min-height:0;padding:20px;font-size:14px;line-height:1.5;overflow-y:auto}.pse-modal-foot[data-v-66d77727]{border-top:1px solid var(--pse-line);flex:none;justify-content:flex-end;align-items:center;gap:9px;padding:15px 20px;display:flex}@media (width<=640px){.pse-modal[data-v-66d77727]{padding:16px 12px}.pse-modal-head[data-v-66d77727],.pse-modal-body[data-v-66d77727],.pse-modal-foot[data-v-66d77727]{padding-left:16px;padding-right:16px}}.pse-note[data-v-4d43dc00]{text-align:left}.pse-note-alert[data-v-4d43dc00]{color:#8a5a10;background-color:#e2a02e1c;border:1px solid #b4761452;border-left-width:3px;border-radius:12px;align-items:flex-start;gap:9px;margin:0 0 12px;padding:11px 13px;font-size:13px;font-weight:600;line-height:1.4;animation:2.4s ease-in-out infinite pse-note-breathe-4d43dc00;display:flex}.pse-note-alert-icon[data-v-4d43dc00]{flex:none;font-size:18px;line-height:1.2}@keyframes pse-note-breathe-4d43dc00{50%{background-color:#e2a02e3d;border-color:#b47614bf}}.pse-note-card[data-v-4d43dc00]{border:1px solid var(--pse-line);background-color:#fff;border-radius:14px;overflow:hidden;box-shadow:0 1px 2px #1430210a}.pse-note-head[data-v-4d43dc00]{border-bottom:1px solid var(--pse-line);background-color:var(--pse-well);align-items:center;gap:9px;padding:10px 14px;display:flex}.pse-note-logo[data-v-4d43dc00]{filter:grayscale()brightness(.72);flex:none;width:18px;height:18px}.pse-note-title[data-v-4d43dc00]{letter-spacing:.06em;text-transform:uppercase;color:var(--pse-ink-faint);margin:0;font-size:10.5px;font-weight:650;line-height:1.6}.pse-note-body[data-v-4d43dc00]{padding:12px 14px 14px}.pse-note-field[data-v-4d43dc00]{box-sizing:border-box;border:1px solid var(--pse-line);background-color:var(--pse-well);field-sizing:content;width:100%;min-height:76px;max-height:260px;font:inherit;color:var(--pse-ink);resize:vertical;border-radius:10px;margin:0;padding:9px 11px;font-size:14px;line-height:1.45;transition:border-color .15s,background-color .15s,box-shadow .15s;display:block}.pse-note-field[data-v-4d43dc00]::placeholder{color:var(--pse-ink-faint)}.pse-note-field[data-v-4d43dc00]:focus{border-color:var(--pse-brand);box-shadow:0 0 0 3px var(--pse-brand-ring);background-color:#fff;outline:none}.pse-note-field[data-v-4d43dc00]:disabled{color:var(--pse-ink-soft);cursor:default}.pse-note-field-waiting[data-v-4d43dc00]{resize:none;flex-direction:column;justify-content:center;gap:9px;display:flex}.pse-note-shimmer[data-v-4d43dc00]{background-color:var(--pse-line);border-radius:5px;height:10px;animation:1.4s ease-in-out infinite pse-note-pulse-4d43dc00}.pse-note-shimmer-short[data-v-4d43dc00]{width:62%;animation-delay:.2s}@keyframes pse-note-pulse-4d43dc00{50%{opacity:.45}}.pse-note-actions[data-v-4d43dc00]{gap:8px;margin-top:10px;display:flex}.pse-note-btn[data-v-4d43dc00]{background-color:var(--pse-brand-ink);min-width:0;height:36px;font:inherit;color:#fff;white-space:nowrap;text-overflow:ellipsis;cursor:pointer;border:1px solid #0000;border-radius:10px;flex:1;padding:0 12px;font-size:13px;font-weight:650;transition:background-color .15s,border-color .15s,color .15s;overflow:hidden}.pse-note-btn[data-v-4d43dc00]:hover:not(:disabled){background-color:var(--pse-brand-ink-strong)}.pse-note-btn[data-v-4d43dc00]:focus{outline:none}.pse-note-btn[data-v-4d43dc00]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-note-btn[data-v-4d43dc00]:disabled{color:#fff;cursor:not-allowed;background-color:#dfe6e2}.pse-note-btn-quiet[data-v-4d43dc00]{border-color:var(--pse-line);color:var(--pse-ink-soft);background-color:#fff}.pse-note-btn-quiet[data-v-4d43dc00]:hover:not(:disabled){border-color:var(--pse-brand);background-color:var(--pse-brand-soft);color:var(--pse-brand-ink)}.pse-note-btn-quiet[data-v-4d43dc00]:disabled{border-color:var(--pse-line);color:var(--pse-ink-faint);background-color:#fff}@media (prefers-reduced-motion:reduce){.pse-note-alert[data-v-4d43dc00]{background-color:#e2a02e3d;border-color:#b47614bf;animation:none}.pse-note-shimmer[data-v-4d43dc00]{animation:none}}.pse-rescard[data-v-a3fdc507]{border:1px solid var(--pse-line);background-color:#fff;border-radius:16px;transition:border-color .15s,box-shadow .15s;overflow:hidden}.pse-rescard+.pse-rescard[data-v-a3fdc507]{margin-top:10px}.pse-rescard[data-v-a3fdc507]:not(.is-incomplete):hover{border-color:var(--pse-brand);box-shadow:0 1px 2px #1430210a,0 14px 30px -24px #14302180}.pse-rescard-head[data-v-a3fdc507]{background-color:var(--pse-well);border-bottom:1px solid var(--pse-line);align-items:center;gap:20px;padding:13px 16px;display:flex}.pse-rescard-id[data-v-a3fdc507]{flex:none;min-width:108px}.pse-rescard-number[data-v-a3fdc507]{font-variant-numeric:tabular-nums;color:var(--pse-ink);font-size:17px;font-weight:700;line-height:1.2;display:block}.pse-rescard-reference[data-v-a3fdc507]{font-variant-numeric:tabular-nums;color:var(--pse-ink-soft);margin-top:1px;font-size:12px;display:block}.pse-rescard-facts[data-v-a3fdc507]{flex:1;gap:26px;min-width:0;margin:0;display:flex}.pse-rescard-fact[data-v-a3fdc507]{min-width:0}.pse-rescard-fact dt[data-v-a3fdc507]{letter-spacing:.06em;text-transform:uppercase;color:var(--pse-ink-faint);margin:0;font-size:10.5px;font-weight:650}.pse-rescard-fact dd[data-v-a3fdc507]{white-space:nowrap;text-overflow:ellipsis;color:var(--pse-ink);margin:2px 0 0;font-size:13.5px;font-weight:600;overflow:hidden}.pse-rescard-open[data-v-a3fdc507]{background-color:var(--pse-brand-ink);height:36px;font:inherit;color:#fff;cursor:pointer;border:0;border-radius:10px;flex:none;align-items:center;gap:2px;padding:0 10px 0 15px;font-size:13.5px;font-weight:650;transition:background-color .15s;display:inline-flex}.pse-rescard-open[data-v-a3fdc507]:hover{background-color:var(--pse-brand-ink-strong)}.pse-rescard-open[data-v-a3fdc507]:focus{outline:none}.pse-rescard-open[data-v-a3fdc507]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-rescard-open-icon[data-v-a3fdc507]{font-size:18px}.pse-rescard-products[data-v-a3fdc507]{overflow-x:auto}.pse-rescard-amount[data-v-a3fdc507]{font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:8px;padding:2px 9px;font-size:13px;font-weight:600;display:inline-block}.pse-rescard-amount.is-short[data-v-a3fdc507]{color:#8a5a10;background-color:#e2a02e2e}.pse-rescard-note[data-v-a3fdc507]{border-top:1px solid var(--pse-line);padding:14px 16px}@media (width<=720px){.pse-rescard-head[data-v-a3fdc507]{flex-wrap:wrap;gap:12px 20px}.pse-rescard-facts[data-v-a3fdc507]{flex-basis:100%;order:1;gap:18px}.pse-rescard-open[data-v-a3fdc507]{margin-left:auto}}.pse-row[data-v-d92fb2b1]{border-top:1px solid var(--pse-line);grid-template-columns:auto minmax(0,1.4fr) minmax(0,1fr) auto;align-items:center;gap:16px;padding:11px 16px;font-size:14px;transition:background-color .15s;display:grid}.pse-row[data-v-d92fb2b1]:first-child{border-top:0}.pse-row[data-v-d92fb2b1]:hover{background-color:var(--pse-well)}.pse-row-number[data-v-d92fb2b1]{font-variant-numeric:tabular-nums;color:var(--pse-ink);font-weight:650}.pse-row-customer[data-v-d92fb2b1],.pse-row-reference[data-v-d92fb2b1]{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.pse-row-customer[data-v-d92fb2b1]{color:var(--pse-ink)}.pse-row-reference[data-v-d92fb2b1]{font-variant-numeric:tabular-nums;color:var(--pse-ink-soft);font-size:13px}.pse-row-open[data-v-d92fb2b1]{border:1px solid var(--pse-line);height:32px;font:inherit;color:var(--pse-ink-soft);cursor:pointer;background-color:#fff;border-radius:9px;align-items:center;gap:2px;padding:0 8px 0 12px;font-size:13px;font-weight:650;transition:border-color .15s,background-color .15s,color .15s;display:inline-flex}.pse-row:hover .pse-row-open[data-v-d92fb2b1]{border-color:var(--pse-brand);background-color:var(--pse-brand-soft);color:var(--pse-brand-ink)}.pse-row-open[data-v-d92fb2b1]:focus{outline:none}.pse-row-open[data-v-d92fb2b1]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-row-open-icon[data-v-d92fb2b1]{font-size:18px}.pse-row-state[data-v-d92fb2b1]{white-space:nowrap;border-radius:999px;align-items:center;gap:7px;padding:4px 11px;font-size:12.5px;font-weight:650;display:inline-flex}.pse-row-mark[data-v-d92fb2b1]{background-color:currentColor;border-radius:50%;flex:none;width:7px;height:7px}.pse-row-state.is-queued[data-v-d92fb2b1]{background-color:var(--pse-well);color:var(--pse-ink-faint)}.pse-row-state.is-busy[data-v-d92fb2b1]{color:#8a5a10;background-color:#e2a02e29}.pse-row-state.is-busy .pse-row-mark[data-v-d92fb2b1]{animation:1.6s ease-in-out infinite pse-row-pulse-d92fb2b1}@keyframes pse-row-pulse-d92fb2b1{50%{opacity:.3}}.pse-row-state.is-done[data-v-d92fb2b1]{background-color:var(--pse-brand-soft);color:var(--pse-brand-ink)}.pse-row-state.is-failed[data-v-d92fb2b1]{background-color:var(--pse-alert-soft);color:var(--pse-alert-ink)}.pse-row.is-failed[data-v-d92fb2b1]{background-color:var(--pse-alert-wash)}@media (prefers-reduced-motion:reduce){.pse-row-state.is-busy .pse-row-mark[data-v-d92fb2b1]{animation:none}}@media (width<=720px){.pse-row[data-v-d92fb2b1]{grid-template-columns:auto minmax(0,1fr) auto;gap:12px}.pse-row-reference[data-v-d92fb2b1]{display:none}}.pse-mc[data-v-6cf2b0f8]{border:1px solid var(--pse-line);background-color:var(--pse-well);border-radius:14px;margin-bottom:12px;padding:15px 17px;transition:border-color .2s,background-color .2s}.pse-mc.is-running[data-v-6cf2b0f8]{background-color:#e2a02e12;border-color:#e2a02e66}.pse-mc.is-done[data-v-6cf2b0f8]{border-color:var(--pse-brand);background-color:var(--pse-brand-soft)}.pse-mc-head[data-v-6cf2b0f8]{align-items:center;gap:13px;display:flex}.pse-mc-icon[data-v-6cf2b0f8]{border:1px solid var(--pse-line);width:36px;height:36px;color:var(--pse-brand-ink);background-color:#fff;border-radius:11px;flex:none;justify-content:center;align-items:center;display:flex}.pse-mc.is-running .pse-mc-icon[data-v-6cf2b0f8]{color:#8a5a10;border-color:#e2a02e66}.pse-mc-titles[data-v-6cf2b0f8]{flex:1;min-width:0}.pse-mc-title[data-v-6cf2b0f8]{color:var(--pse-ink);margin:0;font-size:14.5px;font-weight:650;line-height:1.3}.pse-mc-subtitle[data-v-6cf2b0f8]{color:var(--pse-ink-soft);margin:3px 0 0;font-size:12.5px;line-height:1.4}.pse-mc-controls[data-v-6cf2b0f8]{flex:none;align-items:center;gap:10px;display:flex}.pse-mc-stepper[data-v-6cf2b0f8]{border:1px solid var(--pse-line);background-color:#fff;border-radius:11px;align-items:center;height:40px;display:flex;overflow:hidden}.pse-mc-step[data-v-6cf2b0f8]{width:34px;height:100%;font:inherit;color:var(--pse-ink-soft);cursor:pointer;background-color:#0000;border:0;padding:0;font-size:17px;line-height:1;transition:background-color .15s,color .15s}.pse-mc-step[data-v-6cf2b0f8]:hover:not(:disabled){background-color:var(--pse-brand-soft);color:var(--pse-brand-ink)}.pse-mc-step[data-v-6cf2b0f8]:disabled{color:var(--pse-line);cursor:not-allowed}.pse-mc-step[data-v-6cf2b0f8]:focus{outline:none}.pse-mc-step[data-v-6cf2b0f8]:focus-visible{box-shadow:inset 0 0 0 2px var(--pse-brand-ring);outline:none}.pse-mc-amount[data-v-6cf2b0f8]{border:0;border-left:1px solid var(--pse-line);border-right:1px solid var(--pse-line);width:46px;height:100%;font:inherit;font-variant-numeric:tabular-nums;text-align:center;color:var(--pse-ink);background-color:#0000;padding:0;font-size:15px;font-weight:650}.pse-mc-amount[data-v-6cf2b0f8]:focus{background-color:var(--pse-brand-soft);outline:none}.pse-mc-amount[data-v-6cf2b0f8]::-webkit-inner-spin-button{appearance:none;margin:0}.pse-mc-amount[data-v-6cf2b0f8]::-webkit-outer-spin-button{appearance:none;margin:0}.pse-mc-start[data-v-6cf2b0f8]{flex:none}.pse-mc-tally[data-v-6cf2b0f8]{flex:none;align-items:baseline;gap:6px;display:flex}.pse-mc-tally-count[data-v-6cf2b0f8]{font-variant-numeric:tabular-nums;color:var(--pse-ink);font-size:20px;font-weight:700;line-height:1}.pse-mc-tally-of[data-v-6cf2b0f8]{color:var(--pse-ink-faint);font-size:14px;font-weight:650}.pse-mc-tally-label[data-v-6cf2b0f8]{color:var(--pse-ink-soft);font-size:12px}.pse-mc-progress[data-v-6cf2b0f8]{background-color:#142b2214;border-radius:999px;height:6px;margin-top:13px;overflow:hidden}.pse-mc-progress-fill[data-v-6cf2b0f8]{background-color:var(--pse-brand);border-radius:999px;height:100%;transition:width .4s cubic-bezier(.2,.9,.3,1)}@media (width<=720px){.pse-mc-head[data-v-6cf2b0f8]{flex-wrap:wrap}.pse-mc-titles[data-v-6cf2b0f8]{flex-basis:100%;order:-1}.pse-mc-controls[data-v-6cf2b0f8],.pse-mc-tally[data-v-6cf2b0f8]{margin-left:auto}}.pse-found[data-v-4b31bd48]{border:1px solid var(--pse-line);background-color:var(--pse-well);border-radius:14px;align-items:center;gap:16px;margin-bottom:20px;padding:14px 16px;display:flex}.pse-found-image[data-v-4b31bd48]{border:1px solid var(--pse-line);background-color:#fff;border-radius:11px;flex:none;justify-content:center;align-items:center;width:58px;height:58px;display:flex;overflow:hidden}.pse-found-image img[data-v-4b31bd48]{object-fit:contain;max-width:100%;max-height:100%}.pse-found-text[data-v-4b31bd48]{flex:1;min-width:0}.pse-found-name[data-v-4b31bd48]{color:var(--pse-ink);margin:0;font-size:15.5px;font-weight:650;line-height:1.3}.pse-found-barcode[data-v-4b31bd48]{font-variant-numeric:tabular-nums;color:var(--pse-ink-soft);margin:3px 0 0;font-size:13px}.pse-found-count[data-v-4b31bd48]{flex:none;align-items:baseline;gap:6px;display:flex}.pse-found-count-number[data-v-4b31bd48]{font-variant-numeric:tabular-nums;color:var(--pse-brand-ink);font-size:22px;font-weight:700;line-height:1}.pse-found-count-label[data-v-4b31bd48]{color:var(--pse-ink-soft);font-size:12.5px}.pse-countdown[data-v-4b31bd48]{border:1px solid var(--pse-brand);background-color:var(--pse-brand-soft);color:var(--pse-brand-ink);border-radius:12px;align-items:center;gap:9px;margin:0 0 20px;padding:11px 14px;font-size:13.5px;font-weight:600;display:flex}.pse-countdown-mark[data-v-4b31bd48]{background-color:var(--pse-brand);border-radius:50%;flex:none;width:8px;height:8px;animation:1s ease-in-out infinite pse-countdown-tick-4b31bd48}@keyframes pse-countdown-tick-4b31bd48{50%{opacity:.25}}@media (prefers-reduced-motion:reduce){.pse-countdown-mark[data-v-4b31bd48]{animation:none}}.pse-group+.pse-group[data-v-4b31bd48]{margin-top:26px}.pse-group-head[data-v-4b31bd48]{margin-bottom:10px}.pse-group-title[data-v-4b31bd48]{letter-spacing:.02em;color:var(--pse-ink);align-items:center;gap:8px;margin:0;font-size:14px;font-weight:650;display:flex}.pse-group-count[data-v-4b31bd48]{background-color:var(--pse-brand-soft);font-variant-numeric:tabular-nums;min-width:22px;height:20px;color:var(--pse-brand-ink);border-radius:999px;justify-content:center;align-items:center;padding:0 7px;font-size:12px;font-weight:700;display:inline-flex}.pse-group-note[data-v-4b31bd48]{color:var(--pse-ink-soft);margin:4px 0 0;font-size:12.5px;line-height:1.45}.pse-rows[data-v-4b31bd48]{border:1px solid var(--pse-line);background-color:#fff;border-radius:14px;overflow:hidden}.pse-panel[data-v-db6c4f53]{flex-direction:column;gap:18px;min-width:0;display:flex}.pse-panel-head[data-v-db6c4f53]{align-items:center;gap:12px;display:flex}.pse-panel-icon[data-v-db6c4f53]{background-color:var(--pse-brand-soft);width:38px;height:38px;color:var(--pse-brand-ink);border-radius:11px;flex:none;justify-content:center;align-items:center;display:flex}.pse-panel-text[data-v-db6c4f53]{min-width:0}.pse-panel-title[data-v-db6c4f53]{color:var(--pse-ink);margin:0;font-size:16px;font-weight:650;line-height:1.3}.pse-panel-subtitle[data-v-db6c4f53]{color:var(--pse-ink-soft);margin:2px 0 0;font-size:12.5px;line-height:1.4}.pse-field[data-v-4e6001fa]{cursor:text;margin:0;display:block}.pse-field-label[data-v-4e6001fa]{letter-spacing:.07em;text-transform:uppercase;color:var(--pse-ink-soft);margin-bottom:7px;font-size:11px;font-weight:650;display:block}.pse-field-shell[data-v-4e6001fa]{display:block}.pse-field-shell[data-v-4e6001fa] .pse-input{box-sizing:border-box;border:1px solid var(--pse-line);background-color:var(--pse-well);width:100%;height:48px;font:inherit;color:var(--pse-ink);border-radius:12px;margin:0;padding:0 15px;font-size:15px;transition:border-color .15s,background-color .15s,box-shadow .15s;display:block}.pse-field-shell[data-v-4e6001fa] .pse-input::placeholder{color:var(--pse-ink-faint)}.pse-field-shell[data-v-4e6001fa] .pse-input:-webkit-autofill{-webkit-text-fill-color:var(--pse-ink);box-shadow:0 0 0 100px var(--pse-well) inset}.pse-field-shell[data-v-4e6001fa] .pse-input:-webkit-autofill:hover{-webkit-text-fill-color:var(--pse-ink);box-shadow:0 0 0 100px var(--pse-well) inset}.pse-field-shell[data-v-4e6001fa] .pse-input:focus{border-color:var(--pse-brand);box-shadow:0 0 0 3px var(--pse-brand-ring);background-color:#fff;outline:none}.pse-field-shell[data-v-4e6001fa] .pse-input:-webkit-autofill:focus{box-shadow:0 0 0 100px #fff inset, 0 0 0 3px var(--pse-brand-ring)}.pse-resume[data-v-0485d42f]{border:1px solid var(--pse-line);width:100%;font:inherit;text-align:left;color:var(--pse-ink);cursor:pointer;background-color:#fff;border-radius:14px;align-items:center;gap:13px;margin:0;padding:13px 16px;transition:border-color .15s,box-shadow .15s,transform .15s;display:flex}.pse-resume[data-v-0485d42f]:hover:not(:disabled){border-color:var(--pse-brand);transform:translateY(-1px);box-shadow:0 6px 18px -12px #14302180}.pse-resume[data-v-0485d42f]:focus{outline:none}.pse-resume[data-v-0485d42f]:focus-visible{border-color:var(--pse-brand);box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-resume[data-v-0485d42f]:disabled{background-color:var(--pse-well);color:var(--pse-ink-faint);cursor:not-allowed}.pse-resume-icon[data-v-0485d42f]{background-color:var(--pse-brand-soft);width:34px;height:34px;color:var(--pse-brand-ink);border-radius:10px;flex:none;justify-content:center;align-items:center;display:flex}.pse-resume:disabled .pse-resume-icon[data-v-0485d42f]{color:var(--pse-ink-faint);background-color:#1430210d}.pse-resume-text[data-v-0485d42f]{flex-direction:column;gap:2px;min-width:0;margin-right:auto;display:flex}.pse-resume-label[data-v-0485d42f]{font-size:13px;font-weight:600;line-height:1.3}.pse-resume-number[data-v-0485d42f]{color:var(--pse-ink-soft);font-variant-numeric:tabular-nums;font-size:12px;line-height:1.3}.pse-resume:disabled .pse-resume-number[data-v-0485d42f]{color:var(--pse-ink-faint)}.pse-resume-chevron[data-v-0485d42f]{color:var(--pse-ink-faint);flex:none;transition:transform .15s,color .15s}.pse-resume:hover:not(:disabled) .pse-resume-chevron[data-v-0485d42f]{color:var(--pse-brand-ink);transform:translate(2px)}.pse-search[data-v-3547d191]{box-sizing:border-box;max-width:980px;color:var(--pse-ink);text-align:left;margin:28px auto 56px;padding:0 24px}.pse-search[data-v-3547d191] *{box-sizing:border-box}.pse-messages[data-v-3547d191]:empty{display:none}.pse-card[data-v-3547d191]{border:1px solid var(--pse-line);background-color:#fff;border-radius:20px;grid-template-columns:1fr auto 1fr;gap:34px;padding:30px 34px;display:grid;box-shadow:0 1px 2px #1430210a,0 18px 40px -28px #14302173}.pse-card-split[data-v-3547d191]{background-color:var(--pse-line);width:1px}.pse-form[data-v-3547d191]{flex-direction:column;flex:1;gap:18px;margin:0;display:flex}.pse-submit[data-v-3547d191]{background-color:var(--pse-brand-ink);width:100%;height:48px;font:inherit;color:#fff;cursor:pointer;border:0;border-radius:12px;justify-content:center;align-items:center;gap:9px;margin:0;padding:0 18px;font-size:14.5px;font-weight:650;transition:background-color .15s,box-shadow .15s,transform .15s;display:flex}.pse-submit-end[data-v-3547d191]{margin-top:auto}.pse-submit[data-v-3547d191]:hover:not(:disabled){background-color:var(--pse-brand-ink-strong);transform:translateY(-1px);box-shadow:0 10px 22px -14px #143021cc}.pse-submit[data-v-3547d191]:active:not(:disabled){box-shadow:none;transform:translateY(0)}.pse-submit[data-v-3547d191]:focus{outline:none}.pse-submit[data-v-3547d191]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-submit[data-v-3547d191]:disabled{color:#fff;cursor:not-allowed;background-color:#cfdbd4}.pse-spinner[data-v-3547d191]{border:2px solid #fff6;border-top-color:#fff;border-radius:50%;flex:none;width:15px;height:15px;animation:.7s linear infinite pse-spin-3547d191}@keyframes pse-spin-3547d191{to{transform:rotate(360deg)}}.pse-resume-row[data-v-3547d191]{grid-template-columns:1fr 1fr;gap:14px;margin-top:18px;display:grid}@media (width<=860px){.pse-search[data-v-3547d191]{padding:0 16px}.pse-card[data-v-3547d191]{grid-template-columns:1fr;gap:26px;padding:26px 22px}.pse-card-split[data-v-3547d191]{width:auto;height:1px}.pse-submit-end[data-v-3547d191]{margin-top:0}.pse-resume-row[data-v-3547d191]{grid-template-columns:1fr}}.pse-loading[data-v-a6ea48b7]{box-sizing:border-box;min-height:calc(100vh - 200px);color:var(--pse-ink);text-align:left;justify-content:center;align-items:center;padding:48px 24px;display:flex}.pse-loading-card[data-v-a6ea48b7]{border:1px solid var(--pse-line);background-color:#fff;border-radius:20px;align-items:center;gap:16px;width:100%;max-width:420px;padding:24px 26px;display:flex;box-shadow:0 1px 2px #1430210a,0 18px 40px -28px #14302173}.pse-loading-spinner[data-v-a6ea48b7]{border:3px solid var(--pse-brand-ring);border-top-color:var(--pse-brand);border-radius:50%;flex:none;width:28px;height:28px;animation:.7s linear infinite pse-loading-spin-a6ea48b7}@keyframes pse-loading-spin-a6ea48b7{to{transform:rotate(360deg)}}.pse-loading-text[data-v-a6ea48b7]{min-width:0}.pse-loading-title[data-v-a6ea48b7]{color:var(--pse-ink);margin:0;font-size:16px;font-weight:650;line-height:1.3}.pse-loading-subtitle[data-v-a6ea48b7]{color:var(--pse-ink-soft);margin:3px 0 0;font-size:12.5px;line-height:1.4}@media (prefers-reduced-motion:reduce){.pse-loading-spinner[data-v-a6ea48b7]{animation-duration:1.6s}}@media (width<=860px){.pse-loading[data-v-a6ea48b7]{padding:32px 16px}}.pse-sidebar[data-v-b5e347f6]{box-sizing:border-box;text-align:left;color:var(--pse-ink);flex-direction:column;gap:14px;display:flex}.pse-sidebar[data-v-b5e347f6] *{box-sizing:border-box}.pse-sidebar-card[data-v-b5e347f6]{border:1px solid var(--pse-line);background-color:#fff;border-radius:16px;padding:18px 18px 20px;box-shadow:0 1px 2px #1430210a,0 18px 40px -30px #14302173}.pse-sidebar-head[data-v-b5e347f6]{border-bottom:1px solid var(--pse-line);margin-bottom:14px;padding-bottom:14px}.pse-sidebar-heading-row[data-v-b5e347f6]{align-items:center;gap:4px;display:flex}.pse-sidebar-heading[data-v-b5e347f6]{min-width:0;color:var(--pse-ink);margin:0;font-size:19px;font-weight:700;line-height:1.25}.pse-sidebar-chips[data-v-b5e347f6]{flex-wrap:wrap;gap:6px;margin-top:10px;display:flex}.pse-sidebar-chip[data-v-b5e347f6]{border:1px solid var(--pse-brand-ring);background-color:var(--pse-brand-soft);color:var(--pse-brand-ink);border-radius:999px;padding:3px 10px;font-size:11.5px;font-weight:650;line-height:1.5}.pse-sidebar-rows[data-v-b5e347f6]{grid-template-columns:minmax(0,1fr);margin:0;display:grid}.pse-sidebar-label[data-v-b5e347f6]{letter-spacing:.06em;text-transform:uppercase;color:var(--pse-ink-faint);margin:0;font-size:10.5px;font-weight:650;line-height:1.6}.pse-sidebar-value[data-v-b5e347f6]{color:var(--pse-ink);overflow-wrap:anywhere;align-items:baseline;gap:6px;margin:2px 0 11px;font-size:13.5px;font-weight:550;line-height:1.35;display:flex}.pse-sidebar-value[data-v-b5e347f6]:last-child{margin-bottom:0}.pse-sidebar-value-text[data-v-b5e347f6]{overflow-wrap:anywhere;min-width:0}.pse-copy[data-v-b5e347f6]{width:26px;height:26px;color:var(--pse-ink-faint);cursor:pointer;background-color:#0000;border:0;border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .15s,color .15s;display:inline-flex}.pse-copy[data-v-b5e347f6]:hover{background-color:var(--pse-well);color:var(--pse-ink)}.pse-copy[data-v-b5e347f6]:focus{outline:none}.pse-copy[data-v-b5e347f6]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-copy.is-copied[data-v-b5e347f6]{color:var(--pse-brand-ink);background-color:var(--pse-brand-soft)}.pse-copy.is-failed[data-v-b5e347f6]{color:#a3372c;background-color:#b03a2e1a}.pse-copy-icon[data-v-b5e347f6]{font-size:15px;line-height:1}.pse-sidebar-address[data-v-b5e347f6]{border-top:1px solid var(--pse-line);margin-top:16px;padding-top:14px}.pse-sidebar-address-body[data-v-b5e347f6]{color:var(--pse-ink);flex-direction:column;margin:7px 0 0;font-size:13.5px;font-weight:550;line-height:1.45;display:flex}.pse-image[data-v-29447b5d]{border:1px solid var(--pse-line);background-color:#fff;border-radius:14px;justify-content:center;align-items:center;padding:24px;display:flex}.pse-image-photo[data-v-29447b5d]{object-fit:contain;width:100%;max-width:460px;height:46vh;min-height:260px;display:block}.pse-products[data-v-08354c74]{box-sizing:border-box;color:var(--pse-ink);text-align:left;margin-bottom:26px}.pse-products[data-v-08354c74] *{box-sizing:border-box}.pse-count[data-v-08354c74]{font-variant-numeric:tabular-nums;white-space:nowrap;color:var(--pse-ink);border-radius:8px;padding:3px 9px;font-size:13px;font-weight:600;display:inline-block}.pse-count-warn[data-v-08354c74],.pse-count-alert[data-v-08354c74]{animation:2.4s ease-in-out infinite pse-count-breathe-08354c74}.pse-count-warn[data-v-08354c74]{color:#8a5a10;background-color:#e2a02e2e}.pse-count-alert[data-v-08354c74]{color:#a3372c;background-color:#b03a2e1f}@keyframes pse-count-breathe-08354c74{50%{background-color:#e2a02e6b}}.pse-count-alert[data-v-08354c74]{animation-name:pse-count-breathe-alert-08354c74}@keyframes pse-count-breathe-alert-08354c74{50%{background-color:#b03a2e4d}}.pse-count-resolved[data-v-08354c74]{background-color:var(--pse-brand-soft);color:var(--pse-brand-ink)}.pse-mark[data-v-08354c74]{vertical-align:middle;font-size:21px}.pse-mark-done[data-v-08354c74]{color:var(--pse-brand)}.pse-mark-open[data-v-08354c74]{color:var(--pse-ink-faint)}.pse-skeleton-row td[data-v-08354c74]{height:58px}.pse-skeleton-cell[data-v-08354c74]{background-color:var(--pse-line);border-radius:6px;height:12px;animation:1.4s ease-in-out infinite pse-products-pulse-08354c74;display:block}@keyframes pse-products-pulse-08354c74{50%{opacity:.45}}.pse-products-hint[data-v-08354c74]{border:1px solid var(--pse-brand-ring);background-color:var(--pse-brand-soft);color:var(--pse-brand-ink);border-radius:12px;align-items:center;gap:8px;margin:12px 0 0;padding:10px 13px;font-size:13px;font-weight:550;line-height:1.4;display:flex}.pse-products-hint-icon[data-v-08354c74]{flex:none;font-size:18px}@media (prefers-reduced-motion:reduce){.pse-skeleton-cell[data-v-08354c74],.pse-count-warn[data-v-08354c74],.pse-count-alert[data-v-08354c74]{animation:none}}.pse-done[data-v-608aa53e]{box-sizing:border-box;min-height:calc(100vh - 260px);color:var(--pse-ink);text-align:left;justify-content:center;align-items:center;padding:48px 24px;display:flex}.pse-done[data-v-608aa53e] *{box-sizing:border-box}.pse-done-card[data-v-608aa53e]{border:1px solid var(--pse-line);text-align:center;background-color:#fff;border-radius:20px;flex-direction:column;align-items:center;width:100%;max-width:460px;padding:34px 34px 30px;display:flex;box-shadow:0 1px 2px #1430210a,0 18px 40px -28px #14302173}.pse-done-mark[data-v-608aa53e]{background-color:var(--pse-brand-soft);width:62px;height:62px;color:var(--pse-brand-ink);border-radius:50%;justify-content:center;align-items:center;margin-bottom:18px;display:flex}.pse-done-card.is-failed[data-v-608aa53e]{border-color:var(--pse-alert-soft)}.pse-done-mark.is-failed[data-v-608aa53e]{background-color:var(--pse-alert-soft);color:var(--pse-alert-ink)}.pse-done-card.is-failed[data-v-608aa53e]{max-width:560px}.pse-done-card.is-failed .pse-done-number[data-v-608aa53e]{color:var(--pse-alert-ink)}.pse-done-card.is-failed .pse-done-text[data-v-608aa53e]{max-width:46ch}.pse-done-failures[data-v-608aa53e]{text-align:left;width:100%;margin:18px 0 0;padding:0;list-style:none}.pse-done-failure[data-v-608aa53e]{border:1px solid var(--pse-alert-soft);border-left:3px solid var(--pse-alert);background-color:var(--pse-alert-wash);border-radius:12px;padding:12px 14px}.pse-done-failure+.pse-done-failure[data-v-608aa53e]{margin-top:8px}.pse-done-failure-step[data-v-608aa53e]{color:var(--pse-alert-ink);font-size:13.5px;font-weight:650;line-height:1.35;display:block}.pse-done-failure-detail[data-v-608aa53e]{color:var(--pse-ink-soft);overflow-wrap:anywhere;margin-top:4px;font-size:13px;line-height:1.5;display:block}.pse-done-actions[data-v-608aa53e]{gap:10px;width:100%;margin-top:22px;display:flex}.pse-done-actions .pse-done-button[data-v-608aa53e]{margin-top:0}.pse-done-button.is-quiet[data-v-608aa53e]{border:1px solid var(--pse-line);color:var(--pse-ink-soft);background-color:#fff}.pse-done-button.is-quiet[data-v-608aa53e]:hover{border-color:var(--pse-ink-faint);background-color:var(--pse-well);color:var(--pse-ink);box-shadow:none}.pse-done-mark.is-working[data-v-608aa53e]{background-color:var(--pse-well)}.pse-done-spinner[data-v-608aa53e]{border:3px solid var(--pse-brand-ring);border-top-color:var(--pse-brand);border-radius:50%;width:26px;height:26px;animation:.7s linear infinite pse-done-spin-608aa53e}@keyframes pse-done-spin-608aa53e{to{transform:rotate(360deg)}}.pse-done-title[data-v-608aa53e]{color:var(--pse-ink);margin:0;font-size:20px;font-weight:700;line-height:1.25}.pse-done-number[data-v-608aa53e]{font-variant-numeric:tabular-nums;letter-spacing:.01em;color:var(--pse-brand-ink);margin:8px 0 0;font-size:26px;font-weight:700;line-height:1.1}.pse-done-text[data-v-608aa53e]{max-width:34ch;color:var(--pse-ink-soft);margin:12px 0 0;font-size:13.5px;line-height:1.5}.pse-done-button[data-v-608aa53e]{background-color:var(--pse-brand-ink);width:100%;height:48px;font:inherit;color:#fff;cursor:pointer;border:0;border-radius:12px;margin-top:22px;padding:0 18px;font-size:14.5px;font-weight:650;transition:background-color .15s,box-shadow .15s,transform .15s}.pse-done-button[data-v-608aa53e]:hover{background-color:var(--pse-brand-ink-strong);transform:translateY(-1px);box-shadow:0 10px 22px -14px #143021cc}.pse-done-button[data-v-608aa53e]:active{box-shadow:none;transform:translateY(0)}.pse-done-button[data-v-608aa53e]:focus{outline:none}.pse-done-button[data-v-608aa53e]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}@media (prefers-reduced-motion:reduce){.pse-done-spinner[data-v-608aa53e]{animation-duration:1.6s}}@media (width<=860px){.pse-done[data-v-608aa53e]{padding:32px 16px}.pse-done-actions[data-v-608aa53e]{flex-direction:column}.pse-done-card[data-v-608aa53e]{padding:28px 22px 24px}}.pse-products[data-v-d20efe2c]{box-sizing:border-box;color:var(--pse-ink);text-align:left;margin-bottom:26px}.pse-products[data-v-d20efe2c] *{box-sizing:border-box}.pse-products-note[data-v-d20efe2c]{color:var(--pse-ink-faint);flex:none;font-size:12px}.pse-cell-quantity[data-v-d20efe2c]{font-variant-numeric:tabular-nums;white-space:nowrap;font-weight:600}.pse-back-row[data-v-e77303ed]{text-align:left;justify-content:flex-end;margin-bottom:10px;display:flex}.pse-header[data-v-895c5c8c]{box-sizing:border-box;text-align:left;border-bottom:1px solid var(--pse-line);background-color:#fff;width:100%}@media (display-mode:window-controls-overlay){.pse-header[data-v-895c5c8c]{-webkit-app-region:drag;app-region:drag}.pse-header-inner[data-v-895c5c8c]{min-height:env(titlebar-area-height,0px);padding-top:4px;padding-bottom:4px}.pse-header-logo[data-v-895c5c8c]{height:24px}.pse-header-link[data-v-895c5c8c],.pse-header-logo[data-v-895c5c8c]{-webkit-app-region:no-drag;app-region:no-drag}}.pse-header-inner[data-v-895c5c8c]{box-sizing:border-box;align-items:center;max-width:980px;margin:0 auto;padding:16px 24px;display:flex}.pse-header-link[data-v-895c5c8c]{border-radius:10px;margin:-6px -8px;padding:6px 8px;display:inline-flex}.pse-header-link[data-v-895c5c8c]:focus{outline:none}.pse-header-link[data-v-895c5c8c]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}.pse-header-logo[data-v-895c5c8c]{width:auto;height:34px;display:block}@media (width<=860px){.pse-header-inner[data-v-895c5c8c]{padding:14px 16px}.pse-header-logo[data-v-895c5c8c]{height:28px}}.pse-settings-switch[data-v-ae58d194]{border:1px solid var(--pse-line);background-color:var(--pse-well);cursor:pointer;border-radius:13px;align-items:flex-start;gap:11px;padding:13px 14px;display:flex;margin:0 0 34px!important}.pse-settings-checkbox[data-v-ae58d194]{width:17px;height:17px;accent-color:var(--pse-brand-ink);cursor:pointer;flex:none;margin:1px 0 0}.pse-settings-switch-text[data-v-ae58d194]{min-width:0}.pse-settings-switch-title[data-v-ae58d194]{color:var(--pse-ink);font-size:14px;font-weight:650;line-height:1.3;display:block}.pse-settings-field[data-v-ae58d194]{margin-bottom:16px}.pse-settings-field[data-v-ae58d194]:last-child{margin-bottom:0}.pse-settings-group[data-v-ae58d194]{border-top:1px solid var(--pse-line);margin-top:20px;padding-top:18px}.pse-settings-group-title[data-v-ae58d194]{color:var(--pse-ink);margin:0 0 14px;font-size:13px;font-weight:650}.pse-settings-masked[data-v-ae58d194]{-webkit-text-security:disc;text-security:disc}.pse-credentials-intro[data-v-aacf167f]{align-items:flex-start;gap:13px;margin-bottom:20px;display:flex}.pse-credentials-logo[data-v-aacf167f]{flex:none;margin-top:1px}.pse-credentials-subtitle[data-v-aacf167f]{color:var(--pse-ink-soft);margin:0;font-size:13.5px;line-height:1.45}.pse-credentials-field[data-v-aacf167f]{margin-bottom:16px}.pse-credentials-error[data-v-aacf167f]{color:#a3372c;background-color:#b03a2e0f;border:1px solid #b03a2e47;border-radius:12px;margin:0 0 14px;padding:11px 13px;font-size:13px;line-height:1.45}.pse-credentials-error-enter-active[data-v-aacf167f],.pse-credentials-error-leave-active[data-v-aacf167f]{transition:opacity .15s}.pse-credentials-error-enter-from[data-v-aacf167f],.pse-credentials-error-leave-to[data-v-aacf167f]{opacity:0}.pse-credentials-footnote[data-v-aacf167f]{color:var(--pse-ink-faint);margin:0;font-size:12.5px;line-height:1.4}.pse-credentials-masked[data-v-aacf167f]{-webkit-text-security:disc;text-security:disc}.pse-credentials-spinner[data-v-aacf167f]{border:2px solid #fff6;border-top-color:#fff;border-radius:50%;flex:none;width:14px;height:14px;animation:.7s linear infinite pse-credentials-spin-aacf167f}@keyframes pse-credentials-spin-aacf167f{to{transform:rotate(360deg)}}.pse-bar[data-v-08679645]{--pse-on:#a8dcab;--pse-off:#f5bd74;--pse-ink:#ffffffb8;--pse-ink-strong:#fff;--pse-ink-soft:#ffffff73;--pse-well:#ffffff14;background-color:var(--pse-well);color:var(--pse-ink);white-space:nowrap;vertical-align:middle;border-radius:999px;align-items:center;gap:2px;margin-top:-5px;margin-bottom:-5px;padding:2px;font-family:inherit;font-size:12.5px;line-height:1;display:inline-flex}.pse-bar.is-minimal[data-v-08679645]{background-color:#0000;margin:0;padding:0}.pse-bar[data-v-08679645],.pse-bar[data-v-08679645] *{box-sizing:border-box;line-height:1}.pse-pill[data-v-08679645]{font:inherit;color:inherit;cursor:pointer;background-color:#0000;border:0;border-radius:999px;align-items:center;gap:7px;margin:0;padding:5px 11px;font-weight:600;transition:background-color .15s,color .15s;display:inline-flex}.pse-toggle-label[data-v-08679645]{text-align:left;min-width:74px;display:inline-block}.pse-pill[data-v-08679645]:focus,.pse-pill[data-v-08679645]:active{box-shadow:none;outline:none}.pse-pill[data-v-08679645]:focus-visible{outline-offset:2px;outline:2px solid}.pse-icon[data-v-08679645]{flex:none;width:15px;height:15px}.pse-toggle.is-on[data-v-08679645]{color:var(--pse-on);background-color:#a8dcab29}.pse-toggle.is-on[data-v-08679645]:hover{background-color:#a8dcab47}.pse-toggle.is-on .pse-icon[data-v-08679645]{filter:brightness(0)invert(88%)sepia(19%)saturate(505%)hue-rotate(72deg)brightness(97%)contrast(90%)}.pse-toggle.is-off[data-v-08679645]{color:var(--pse-off);background-color:#f5bd7429}.pse-toggle.is-off[data-v-08679645]:hover{background-color:#f5bd7447}.pse-toggle.is-off .pse-icon[data-v-08679645]{filter:brightness(0)invert(84%)sepia(29%)saturate(958%)hue-rotate(324deg)brightness(101%)contrast(92%)}.pse-install[data-v-08679645]{color:var(--pse-ink-strong);background-color:#ffffff24}.pse-install[data-v-08679645]:hover{background-color:#ffffff3d}.pse-install .pse-icon[data-v-08679645]{filter:brightness(0)invert()}.pse-settings[data-v-08679645]{color:var(--pse-ink)}.pse-settings[data-v-08679645]:hover{color:var(--pse-ink-strong);background-color:#ffffff24}.pse-settings .pse-icon[data-v-08679645]{filter:brightness(0)invert();opacity:.72;transition:transform .3s,opacity .15s}.pse-settings:hover .pse-icon[data-v-08679645]{opacity:1;transform:rotate(60deg)}.pse-divider[data-v-08679645]{opacity:.18;background-color:currentColor;width:1px;height:15px;margin:0 4px}.pse-user[data-v-08679645]{align-items:center;gap:6px;padding:0 6px;display:inline-flex}.pse-user-name[data-v-08679645]{color:var(--pse-ink-strong);font-weight:600}.pse-dot[data-v-08679645]{background-color:var(--pse-on);border-radius:50%;flex:none;width:6px;height:6px;animation:2.6s ease-out infinite pse-dot-pulse-08679645}@keyframes pse-dot-pulse-08679645{0%{box-shadow:0 0 #a8dcab80}70%{box-shadow:0 0 0 7px #a8dcab00}to{box-shadow:0 0 #a8dcab00}}@media (prefers-reduced-motion:reduce){.pse-dot[data-v-08679645]{animation:none;box-shadow:0 0 0 3px #a8dcab33}}.pse-version[data-v-08679645]{color:var(--pse-ink-soft);letter-spacing:.04em;text-transform:uppercase;align-items:baseline;gap:5px;padding:0 6px;font-size:10.5px;display:inline-flex}.pse-bar.is-minimal .pse-version[data-v-08679645]{padding-left:0}.pse-version-number[data-v-08679645]{font-variant-numeric:tabular-nums;letter-spacing:.02em}@media (width<=991px){.pse-bar:not(.is-minimal) .pse-brand[data-v-08679645]{display:none}}@media (width<=767px){.pse-settings-label[data-v-08679645]{display:none}.pse-install-label[data-v-08679645]{font-size:0}.pse-install-label[data-v-08679645]:after{content:\"App\";font-size:12.5px}}.pse-login[data-v-1c242fec]{box-sizing:border-box;min-height:calc(100vh - 200px);color:var(--pse-ink);text-align:left;justify-content:center;align-items:center;padding:48px 24px;display:flex}.pse-login[data-v-1c242fec] *{box-sizing:border-box}.pse-login-card[data-v-1c242fec]{border:1px solid var(--pse-line);background-color:#fff;border-radius:20px;width:100%;max-width:420px;padding:30px 34px;box-shadow:0 1px 2px #1430210a,0 18px 40px -28px #14302173}.pse-login-errors[data-v-1c242fec]:not(:has(.validation-summary-errors)){display:none}.pse-login-errors[data-v-1c242fec] ul{color:#a3372c;background-color:#b03a2e0f;border:1px solid #b03a2e47;border-radius:12px;margin:0;padding:12px 14px;font-size:13px;line-height:1.45;list-style:none}.pse-login[data-v-1c242fec] input[type=number]{appearance:textfield}.pse-login[data-v-1c242fec] input[type=number]::-webkit-outer-spin-button{appearance:none;margin:0}.pse-login[data-v-1c242fec] input[type=number]::-webkit-inner-spin-button{appearance:none;margin:0}.pse-submit[data-v-1c242fec]{background-color:var(--pse-brand-ink);width:100%;height:48px;font:inherit;color:#fff;cursor:pointer;border:0;border-radius:12px;justify-content:center;align-items:center;margin:4px 0 0;padding:0 18px;font-size:14.5px;font-weight:650;transition:background-color .15s,box-shadow .15s,transform .15s;display:flex}.pse-submit[data-v-1c242fec]:hover{background-color:var(--pse-brand-ink-strong);transform:translateY(-1px);box-shadow:0 10px 22px -14px #143021cc}.pse-submit[data-v-1c242fec]:active{box-shadow:none;transform:translateY(0)}.pse-submit[data-v-1c242fec]:focus{outline:none}.pse-submit[data-v-1c242fec]:focus-visible{box-shadow:0 0 0 3px var(--pse-brand-ring);outline:none}@media (width<=860px){.pse-login[data-v-1c242fec]{padding:32px 16px}.pse-login-card[data-v-1c242fec]{padding:26px 22px}}\n/*$vite$:1*/ ");
	...
	var RESERVATION_SUMMARY_SELECTOR = "#ReservationSummary\\ mb-2";
	...
	var COMPLETED_PROCEED_SELECTOR = "#ReservationContainer > div:nth-child(11) > div > button";
	...
	var enabled = _GM_getValue("PSE_Debug", false);
	function debug(...args) {
		if (enabled) console.log("[PSE]", ...args);
	}
	...
	function getReservationSidebarColumn() {
		return document.querySelector("#ReservationOverview > div:nth-child(2) > div.col-3") ?? document.querySelector("#ReservationSummary\\ mb-2")?.parentElement ?? null;
	}
	...
	function focusBarcodeInput() {
		afterReveal(() => {
			const barcodeInput = document.querySelector("#Productbarcode");
	...
	function retrieveModalData(modalElement) {
		const amount = modalElement.querySelector("#productReservationsModal > div > div > div.modal-header > h5").innerText.trimStart()[0];
	...
	var _hoisted_2$21 = { class: "pse-modal-head" };
	var _hoisted_3$18 = { class: "pse-modal-title" };
	var _hoisted_4$17 = { class: "pse-modal-body" };
	var _hoisted_5$16 = {
		key: 0,
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					createBaseVNode("header", _hoisted_2$21, [createBaseVNode("h2", _hoisted_3$18, toDisplayString(__props.title), 1), createBaseVNode("button", {
						type: "button",
					...
					createBaseVNode("div", _hoisted_4$17, [renderSlot(_ctx.$slots, "default", {}, void 0, true)]),
					_ctx.$slots.footer ? (openBlock(), createElementBlock("footer", _hoisted_5$16, [renderSlot(_ctx.$slots, "footer", {}, void 0, true)])) : createCommentVNode("", true)
				], 2)], 42, _hoisted_1$21);
			};
		}
	});
	...
	var _hoisted_1$20 = { class: "pse-note" };
	var _hoisted_2$20 = {
		key: 0,
		class: "pse-note-alert"
	};
	var _hoisted_3$17 = { class: "pse-note-card" };
	var _hoisted_4$16 = { class: "pse-note-head" };
	var _hoisted_5$15 = ["src"];
	var _hoisted_6$12 = { class: "pse-note-body" };
	var _hoisted_7$10 = ["disabled", "placeholder"];
	var _hoisted_8$9 = {
		key: 1,
		class: "pse-note-field pse-note-field-waiting",
		"aria-hidden": "true"
	};
	var _hoisted_9$9 = { class: "pse-note-actions" };
	...
	var ShopwareNote_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("section", _hoisted_1$20, [createVNode(Transition, null, {
					default: withCtx(() => [__props.showAlert && hasNote.value ? (openBlock(), createElementBlock("p", _hoisted_2$20, [..._cache[3] || (_cache[3] = [createBaseVNode("span", {
					...
					_: 1
				}), createBaseVNode("div", _hoisted_3$17, [createBaseVNode("header", _hoisted_4$16, [createBaseVNode("img", {
					class: "pse-note-logo",
					src: unref(shopware_default),
					alt: ""
				}, null, 8, _hoisted_5$15), _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "pse-note-title" }, "Shopware notitie", -1))]), createBaseVNode("div", _hoisted_6$12, [__props.orderData ? withDirectives((openBlock(), createElementBlock("textarea", {
					key: 0,
				...
				}, null, 8, _hoisted_7$10)), [[vModelText, __props.orderData.customerComment]]) : (openBlock(), createElementBlock("div", _hoisted_8$9, [..._cache[5] || (_cache[5] = [createBaseVNode("span", { class: "pse-note-shimmer" }, null, -1), createBaseVNode("span", { class: "pse-note-shimmer pse-note-shimmer-short" }, null, -1)])])), createBaseVNode("div", _hoisted_9$9, [__props.showOpen ? (openBlock(), createElementBlock("button", {
					key: 0,
					type: "button",
					class: "pse-note-btn pse-note-btn-quiet",
					disabled: !ready.value,
					onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$emit("open"))
				}, " Open in Shopware ", 8, _hoisted_10$9)) : createCommentVNode("", true), createBaseVNode("button", {
					type: "button",
					class: "pse-note-btn",
					disabled: !ready.value,
					onClick: _cache[2] || (_cache[2] = ($event) => _ctx.$emit("save"))
				}, " Opslaan ", 8, _hoisted_11$7)])])])]);
			};
		}
	}), [["__scopeId", "data-v-4d43dc00"]]);
	var _hoisted_1$19 = { class: "pse-rescard-head" };
	var _hoisted_2$19 = { class: "pse-rescard-id" };
	var _hoisted_3$16 = { class: "pse-rescard-number" };
	var _hoisted_4$15 = { class: "pse-rescard-reference" };
	var _hoisted_5$14 = { class: "pse-rescard-facts" };
	var _hoisted_6$11 = { class: "pse-rescard-fact" };
	var _hoisted_7$9 = { class: "pse-rescard-fact" };
	var _hoisted_8$8 = { class: "pse-rescard-fact" };
	var _hoisted_9$8 = {
		key: 0,
		class: "pse-rescard-products"
	};
	var _hoisted_10$8 = { class: "pse-table" };
	var _hoisted_11$6 = { class: "pse-cell-barcode" };
	var _hoisted_12$6 = { class: "pse-cell-description" };
	var _hoisted_13$5 = { class: "pse-cell-barcode" };
	var _hoisted_14$4 = { class: "pse-table-right" };
	var _hoisted_15$4 = {
		key: 1,
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("article", { class: normalizeClass(["pse-rescard", { "is-incomplete": __props.highlightIncomplete }]) }, [
					createBaseVNode("header", _hoisted_1$19, [
						createBaseVNode("div", _hoisted_2$19, [createBaseVNode("span", _hoisted_3$16, toDisplayString(__props.reservation.reservationNumber), 1), createBaseVNode("span", _hoisted_4$15, toDisplayString(__props.reservation.saleOrderReference), 1)]),
						createBaseVNode("dl", _hoisted_5$14, [
							createBaseVNode("div", _hoisted_6$11, [_cache[2] || (_cache[2] = createBaseVNode("dt", null, "Klant", -1)), createBaseVNode("dd", null, toDisplayString(__props.reservation.customer), 1)]),
							createBaseVNode("div", _hoisted_7$9, [_cache[3] || (_cache[3] = createBaseVNode("dt", null, "Status", -1)), createBaseVNode("dd", null, toDisplayString(__props.reservation.status), 1)]),
							createBaseVNode("div", _hoisted_8$8, [_cache[4] || (_cache[4] = createBaseVNode("dt", null, "Logistiek", -1)), createBaseVNode("dd", null, toDisplayString(__props.reservation.deliveryStatus), 1)])
						]),
					...
					__props.showProducts ? (openBlock(), createElementBlock("div", _hoisted_9$8, [createBaseVNode("table", _hoisted_10$8, [_cache[6] || (_cache[6] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: index }, [
							createBaseVNode("td", _hoisted_11$6, toDisplayString(product.number), 1),
							createBaseVNode("td", _hoisted_12$6, toDisplayString(product.description), 1),
							createBaseVNode("td", _hoisted_13$5, toDisplayString(product.barcode), 1),
							createBaseVNode("td", _hoisted_14$4, [createBaseVNode("span", { class: normalizeClass(["pse-rescard-amount", { "is-short": isShort(product.amount) }]) }, toDisplayString(product.amount), 3)])
						]);
					}), 128))])])])) : createCommentVNode("", true),
					__props.showNote && hasShopwareNote() ? (openBlock(), createElementBlock("div", _hoisted_15$4, [createVNode(ShopwareNote_default, {
	...
	}), [["__scopeId", "data-v-a3fdc507"]]);
	var _hoisted_1$18 = { class: "pse-row-number" };
	var _hoisted_2$18 = { class: "pse-row-customer" };
	var _hoisted_3$15 = { class: "pse-row-reference" };
	var _hoisted_4$14 = { key: 2 };
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", { class: normalizeClass(["pse-row", state.value?.modifier]) }, [
					createBaseVNode("span", _hoisted_1$18, toDisplayString(__props.reservation.reservationNumber), 1),
					createBaseVNode("span", _hoisted_2$18, toDisplayString(__props.reservation.customer), 1),
					createBaseVNode("span", _hoisted_3$15, toDisplayString(__props.reservation.saleOrderReference), 1),
					state.value ? (openBlock(), createElementBlock("span", {
						...
						"aria-hidden": "true"
					}, "chevron_right", -1)])])) : (openBlock(), createElementBlock("span", _hoisted_4$14))
				], 2);
			};
		}
	}), [["__scopeId", "data-v-d92fb2b1"]]);
	var _hoisted_1$17 = { class: "pse-mc-head" };
	var _hoisted_2$17 = { class: "pse-mc-titles" };
	var _hoisted_3$14 = {
		key: 0,
	...
	var _hoisted_8$7 = { class: "pse-mc-stepper" };
	...
	var _hoisted_13$4 = { class: "pse-mc-tally-count" };
	var _hoisted_14$3 = { class: "pse-mc-tally-of" };
	var _hoisted_15$3 = { class: "pse-mc-tally-label" };
	var _hoisted_16$3 = {
		key: 0,
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("section", { class: normalizeClass(["pse-mc", {
					...
					createBaseVNode("div", _hoisted_2$17, [_cache[5] || (_cache[5] = createBaseVNode("h3", { class: "pse-mc-title" }, "Massa voltooien", -1)), !__props.started ? (openBlock(), createElementBlock("p", _hoisted_3$14, " Opent " + toDisplayString(__props.amount) + " van de " + toDisplayString(__props.total) + " reserveringen in de achtergrond en rondt ze af. ", 1)) : !done.value ? (openBlock(), createElementBlock("p", _hoisted_4$13, toDisplayString(settled.value) + " van " + toDisplayString(__props.amount) + " afgerond — laat dit scherm openstaan. ", 1)) : __props.failed > 0 ? (openBlock(), createElementBlock("p", _hoisted_5$13, toDisplayString(__props.finished) + " afgerond, " + toDisplayString(__props.failed) + " mislukt. Mislukte reserveringen staan hieronder. ", 1)) : (openBlock(), createElementBlock("p", _hoisted_6$10, " Alle " + toDisplayString(__props.finished) + " reserveringen zijn afgerond. ", 1))]),
					!__props.started ? (openBlock(), createElementBlock("div", _hoisted_7$8, [createBaseVNode("div", _hoisted_8$7, [
					...
					}, " Start voltooien ")])) : (openBlock(), createElementBlock("div", _hoisted_12$5, [createBaseVNode("span", _hoisted_13$4, [createTextVNode(toDisplayString(settled.value), 1), createBaseVNode("span", _hoisted_14$3, "/" + toDisplayString(__props.amount), 1)]), createBaseVNode("span", _hoisted_15$3, toDisplayString(done.value ? "klaar" : "afgerond"), 1)]))
				]), __props.started ? (openBlock(), createElementBlock("div", _hoisted_16$3, [createBaseVNode("div", {
					class: "pse-mc-progress-fill",
					style: normalizeStyle({ width: `${progress.value}%` })
				}, null, 4)])) : createCommentVNode("", true)], 2);
			};
		}
	}), [["__scopeId", "data-v-6cf2b0f8"]]);
	var _hoisted_1$16 = { class: "pse-found" };
	var _hoisted_2$16 = { class: "pse-found-image" };
	var _hoisted_3$13 = ["src"];
	var _hoisted_4$12 = { class: "pse-found-text" };
	var _hoisted_5$12 = { class: "pse-found-name" };
	var _hoisted_6$9 = { class: "pse-found-barcode" };
	var _hoisted_7$7 = { class: "pse-found-count" };
	var _hoisted_8$6 = { class: "pse-found-count-number" };
	var _hoisted_9$6 = {
		key: 0,
		class: "pse-countdown"
	};
	...
	var _hoisted_11$4 = { class: "pse-group-head" };
	var _hoisted_12$4 = { class: "pse-group-title" };
	var _hoisted_13$3 = { class: "pse-group-count" };
	var _hoisted_14$2 = { class: "pse-rows" };
	var _hoisted_15$2 = {
		key: 1,
		class: "pse-group"
	};
	...
	var _hoisted_20 = { class: "pse-group-head" };
	var _hoisted_21 = { class: "pse-group-title" };
	var _hoisted_22 = { class: "pse-group-count" };
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createBlock(ModalShell_default, {
					...
					default: withCtx(() => [
						createBaseVNode("section", _hoisted_1$16, [
							createBaseVNode("div", _hoisted_2$16, [__props.modalData.searchProductImageUrl ? (openBlock(), createElementBlock("img", {
								key: 0,
								src: __props.modalData.searchProductImageUrl,
								alt: "",
								loading: "lazy"
							}, null, 8, _hoisted_3$13)) : createCommentVNode("", true)]),
							createBaseVNode("div", _hoisted_4$12, [createBaseVNode("h3", _hoisted_5$12, toDisplayString(__props.modalData.searchProductName), 1), createBaseVNode("p", _hoisted_6$9, toDisplayString(__props.modalData.searchProductBarcode), 1)]),
							createBaseVNode("div", _hoisted_7$7, [createBaseVNode("span", _hoisted_8$6, toDisplayString(__props.modalData.searchProductAmount), 1), _cache[5] || (_cache[5] = createBaseVNode("span", { class: "pse-found-count-label" }, "reserveringen", -1))])
						]),
						createVNode(Transition, null, {
							default: withCtx(() => [canAutoProceed() ? (openBlock(), createElementBlock("p", _hoisted_9$6, [_cache[6] || (_cache[6] = createBaseVNode("span", {
						...
						__props.modalData.singleLineReservations.length > 0 ? (openBlock(), createElementBlock("section", _hoisted_10$6, [
							createBaseVNode("header", _hoisted_11$4, [createBaseVNode("h3", _hoisted_12$4, [_cache[7] || (_cache[7] = createTextVNode(" Singleline ", -1)), createBaseVNode("span", _hoisted_13$3, toDisplayString(__props.modalData.singleLineReservations.length), 1)]), _cache[8] || (_cache[8] = createBaseVNode("p", { class: "pse-group-note" }, "Deze reserveringen bevatten 1 stuk van het product.", -1))]),
							...
							createBaseVNode("div", _hoisted_14$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.modalData.singleLineReservations, (reservation) => {
	...
	}), [["__scopeId", "data-v-4b31bd48"]]);
	var _hoisted_1$15 = { class: "pse-panel" };
	var _hoisted_2$15 = { class: "pse-panel-head" };
	var _hoisted_3$12 = {
		class: "pse-panel-icon",
		"aria-hidden": "true"
	};
	var _hoisted_4$11 = { class: "pse-panel-text" };
	var _hoisted_5$11 = { class: "pse-panel-title" };
	var _hoisted_6$8 = { class: "pse-panel-subtitle" };
	var SearchPanel_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("section", _hoisted_1$15, [createBaseVNode("header", _hoisted_2$15, [createBaseVNode("span", _hoisted_3$12, [renderSlot(_ctx.$slots, "icon", {}, void 0, true)]), createBaseVNode("span", _hoisted_4$11, [createBaseVNode("h2", _hoisted_5$11, toDisplayString(__props.title), 1), createBaseVNode("p", _hoisted_6$8, toDisplayString(__props.subtitle), 1)])]), renderSlot(_ctx.$slots, "default", {}, void 0, true)]);
			};
		}
	}), [["__scopeId", "data-v-db6c4f53"]]);
	var _hoisted_1$14 = { class: "pse-field" };
	var _hoisted_2$14 = { class: "pse-field-label" };
	var _hoisted_3$11 = ["placeholder"];
	var SearchField_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("label", _hoisted_1$14, [createBaseVNode("span", _hoisted_2$14, toDisplayString(__props.label), 1), createBaseVNode("span", {
				...
				}, null, 8, _hoisted_3$11)), [[vModelText, model.value]]) : createCommentVNode("", true)], 512)]);
			};
		}
	}), [["__scopeId", "data-v-4e6001fa"]]);
	var _hoisted_1$13 = ["disabled"];
	var _hoisted_2$13 = {
		class: "pse-resume-icon",
		"aria-hidden": "true"
	};
	var _hoisted_3$10 = { class: "pse-resume-text" };
	var _hoisted_4$10 = { class: "pse-resume-label" };
	var _hoisted_5$10 = { class: "pse-resume-number" };
		...
		setup(__props) {
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("button", {
					...
					createBaseVNode("span", _hoisted_2$13, [renderSlot(_ctx.$slots, "icon", {}, void 0, true)]),
					createBaseVNode("span", _hoisted_3$10, [createBaseVNode("span", _hoisted_4$10, toDisplayString(__props.label), 1), createBaseVNode("span", _hoisted_5$10, toDisplayString(__props.reservationNumber || "Nog geen"), 1)]),
					_cache[1] || (_cache[1] = createBaseVNode("svg", {
	...
	}), [["__scopeId", "data-v-0485d42f"]]);
	var _hoisted_1$12 = { class: "pse-search" };
	var _hoisted_2$12 = { class: "pse-card" };
	...
	var _hoisted_6$7 = { class: "pse-resume-row" };
	...
	var SearchReservationsPage_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			function replacePortalSearchBlock() {
				...
				if (portalMessages && messages.value) adoptElement(messages.value, portalMessages);
					...
					createBaseVNode("div", _hoisted_2$12, [
						createVNode(SearchPanel_default, {
							...
							default: withCtx(() => [
								...
								}, [searching.value ? (openBlock(), createElementBlock("span", _hoisted_4$9)) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(searching.value ? "Bezig met zoeken" : "Zoek"), 1)], 8, _hoisted_3$9)
							]),
							_: 1
						}),
						...
						createVNode(SearchPanel_default, {
							...
							icon: withCtx(() => [..._cache[7] || (_cache[7] = [createBaseVNode("svg", {
								viewBox: "0 0 24 24",
								width: "20",
								height: "20",
								fill: "none",
							...
							default: withCtx(() => [createBaseVNode("form", {
								class: "pse-form",
								onSubmit: _cache[3] || (_cache[3] = withModifiers(($event) => openAddParcels(addParcelsNumber.value), ["prevent"]))
							}, [createVNode(SearchField_default, {
								label: "Reservering nr",
								placeholder: "Bijv. 1234567",
								modelValue: addParcelsNumber.value,
								"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => addParcelsNumber.value = $event)
							}, null, 8, ["modelValue"]), createBaseVNode("button", {
								type: "submit",
								class: "pse-submit pse-submit-end",
								disabled: !addParcelsNumber.value
							}, " Zoek ", 8, _hoisted_5$9)], 32)]),
							_: 1
						})
					]),
					createBaseVNode("div", _hoisted_6$7, [createVNode(ResumeButton_default, {
						label: "Laatst geopende reservering",
						"reservation-number": lastOpenReservation.value?.number,
						disabled: !canReopen.value,
						onClick: _cache[4] || (_cache[4] = ($event) => reopenReservation(lastOpenReservation.value.id))
					}, {
						...
						onClick: _cache[5] || (_cache[5] = ($event) => openAddParcels(lastCompletedReservation.value.number))
					}, {
						...
						_: 1
					}, 8, ["reservation-number", "disabled"])])
				])], 64);
			};
		}
	}), [["__scopeId", "data-v-3547d191"]]);
	...
	var _hoisted_9$5 = ["title"];
	var _hoisted_10$5 = { class: "pse-sidebar-rows" };
	var _hoisted_11$3 = { class: "pse-sidebar-label" };
	var _hoisted_12$3 = { class: "pse-sidebar-value" };
	var _hoisted_13$2 = { class: "pse-sidebar-value-text" };
	...
	var _hoisted_17$1 = { class: "pse-sidebar-label" };
	var _hoisted_18$1 = { class: "pse-sidebar-address-body" };
	var ReservationSidebar_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			const isCopyable = (label) => COPYABLE_LABELS.includes(label);
			const reservationNumber = computed(() => heading.value.match(/\d{3,}/)?.[0] ?? "");
			const copyState = ref();
			let copyTimeout;
			const copyIcon = (key) => copyState.value?.key != key ? "content_copy" : copyState.value.ok ? "check" : "error_outline";
			async function copyValue(key, value) {
				...
				copyTimeout = setTimeout(() => copyState.value = void 0, 1400);
			}
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("aside", _hoisted_1$10, [
					...
					createBaseVNode("div", _hoisted_2$10, [
						createBaseVNode("header", _hoisted_3$7, [createBaseVNode("div", _hoisted_4$7, [createBaseVNode("h2", _hoisted_5$7, toDisplayString(heading.value), 1), reservationNumber.value ? (openBlock(), createElementBlock("button", {
							key: 0,
							type: "button",
							class: normalizeClass(["pse-copy", {
								"is-copied": copyIcon("reservation") == "check",
								"is-failed": copyIcon("reservation") == "error_outline"
							}]),
							title: `Reserveringsnummer ${reservationNumber.value} kopiëren`,
							onClick: _cache[0] || (_cache[0] = ($event) => copyValue("reservation", reservationNumber.value))
						}, [createBaseVNode("span", _hoisted_7$6, toDisplayString(copyIcon("reservation")), 1)], 10, _hoisted_6$6)) : createCommentVNode("", true)]), chips.value.length ? (openBlock(), createElementBlock("div", _hoisted_8$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(chips.value, (chip) => {
							return openBlock(), createElementBlock("span", {
								key: chip.label,
								class: "pse-sidebar-chip",
								title: `${chip.label}: ${chip.value}`
							}, toDisplayString(chip.value), 9, _hoisted_9$5);
						}), 128))])) : createCommentVNode("", true)]),
						createBaseVNode("dl", _hoisted_10$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row) => {
							return openBlock(), createElementBlock(Fragment, { key: row.label }, [createBaseVNode("dt", _hoisted_11$3, toDisplayString(row.label), 1), createBaseVNode("dd", _hoisted_12$3, [createBaseVNode("span", _hoisted_13$2, toDisplayString(row.value), 1), isCopyable(row.label) ? (openBlock(), createElementBlock("button", {
								key: 0,
								type: "button",
								class: normalizeClass(["pse-copy", {
									"is-copied": copyIcon(row.label) == "check",
									"is-failed": copyIcon(row.label) == "error_outline"
								}]),
								title: `${row.label} kopiëren`,
								onClick: ($event) => copyValue(row.label, row.value)
							}, [createBaseVNode("span", _hoisted_15$1, toDisplayString(copyIcon(row.label)), 1)], 10, _hoisted_14$1)) : createCommentVNode("", true)])], 64);
						}), 128))]),
						address.value.length ? (openBlock(), createElementBlock("div", _hoisted_16$1, [createBaseVNode("span", _hoisted_17$1, toDisplayString(addressLabel.value), 1), createBaseVNode("p", _hoisted_18$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(address.value, (line, index) => {
	...
	var _hoisted_8$4 = { class: "pse-cell-barcode" };
	var _hoisted_9$4 = { class: "pse-table-centre" };
	var _hoisted_10$4 = {
		key: 0,
	...
	var _hoisted_12$2 = { class: "pse-table-right" };
	var _hoisted_13$1 = { class: "pse-actions" };
				...
				return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, { to: "body" }, [createVNode(Transition, { name: "modal" }, {
					...
					createBaseVNode("div", _hoisted_4$6, [createBaseVNode("table", _hoisted_5$6, [_cache[4] || (_cache[4] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: product.key }, [
							...
							createBaseVNode("td", _hoisted_8$4, toDisplayString(product.mainBarcode), 1),
							...
							createBaseVNode("td", _hoisted_9$4, [product.verifiedQuantity >= product.requiredQuantity ? (openBlock(), createElementBlock("span", _hoisted_10$4, "check_circle")) : (openBlock(), createElementBlock("span", _hoisted_11$2, "radio_button_unchecked"))]),
							createBaseVNode("td", _hoisted_12$2, [createBaseVNode("div", _hoisted_13$1, [createBaseVNode("button", {
								type: "button",
								class: "pse-action",
								...
								height: "18",
								alt: "Toevoegen"
							}, null, 8, _hoisted_15)], 8, _hoisted_14), createBaseVNode("button", {
								type: "button",
								...
								height: "18",
								alt: "Afbeelding"
							}, null, 8, _hoisted_17)], 8, _hoisted_16)])])
						]);
					}), 128))])) : (openBlock(), createElementBlock("tbody", _hoisted_18, [(openBlock(true), createElementBlock(Fragment, null, renderList(lines.value, (line) => {
	...
	var _hoisted_5$5 = { class: "pse-done-title" };
	var _hoisted_6$4 = {
		key: 0,
		class: "pse-done-number"
	};
	var _hoisted_7$4 = {
		key: 1,
	...
	var CompletedPage_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			onMounted(() => {
				...
				if (failed.value || !Settings.autoMasterSwitch) return;
			...
			function proceedButton() {
				return document.querySelector(COMPLETED_PROCEED_SELECTOR);
			}
			function finalize() {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					ref_key: "root",
					ref: root
				}, [replaced.value ? (openBlock(), createElementBlock("div", _hoisted_1$7, [createBaseVNode("div", { class: normalizeClass(["pse-done-card", { "is-failed": failed.value }]) }, [
					createBaseVNode("span", {
						...
						"aria-hidden": "true"
					}, [failed.value ? (openBlock(), createElementBlock("svg", _hoisted_2$7, [..._cache[3] || (_cache[3] = [
					...
					])])) : !finalizing.value ? (openBlock(), createElementBlock("svg", _hoisted_3$5, [..._cache[4] || (_cache[4] = [createBaseVNode("path", { d: "M5 12.5l4.5 4.5L19 7.5" }, null, -1)])])) : (openBlock(), createElementBlock("span", _hoisted_4$5))], 2),
					createBaseVNode("h1", _hoisted_5$5, toDisplayString(failed.value ? heading.value || "Reservering niet verzonden" : "Reservering afgerond"), 1),
					reservationNumber.value ? (openBlock(), createElementBlock("p", _hoisted_6$4, toDisplayString(reservationNumber.value), 1)) : createCommentVNode("", true),
					failed.value ? (openBlock(), createElementBlock("ul", _hoisted_7$4, [(openBlock(true), createElementBlock(Fragment, null, renderList(failures.value, (failure, index) => {
						return openBlock(), createElementBlock("li", {
							class: "pse-done-failure",
							key: index
						}, [failure.step ? (openBlock(), createElementBlock("span", _hoisted_8$3, toDisplayString(failure.step), 1)) : createCommentVNode("", true), failure.detail ? (openBlock(), createElementBlock("span", _hoisted_9$3, toDisplayString(failure.detail), 1)) : createCommentVNode("", true)]);
					}), 128))])) : createCommentVNode("", true),
					failed.value ? (openBlock(), createElementBlock("p", _hoisted_10$3, " De pakketten zijn niet aangemeld. Ga terug naar de pakketten om het opnieuw te proberen. ")) : finalizing.value ? (openBlock(), createElementBlock("p", _hoisted_11$1, " Wordt afgesloten en gaat terug naar zoeken... ")) : (openBlock(), createElementBlock("p", _hoisted_12$1, " De pakketten zijn aangemeld. Sluit de reservering af om verder te gaan. ")),
					failed.value ? (openBlock(), createElementBlock("div", _hoisted_13, [parcelsUrl.value ? (openBlock(), createElementBlock("button", {
						key: 0,
						type: "button",
	...
	var _hoisted_6$3 = { class: "pse-cell-quantity" };
	var _hoisted_7$3 = { class: "pse-table-right" };
	var _hoisted_8$2 = { class: "pse-actions" };
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, { to: "body" }, [createVNode(Transition, { name: "modal" }, {
					...
					return openBlock(), createElementBlock("tr", { key: product.itemId }, [
						...
						createBaseVNode("td", _hoisted_5$4, toDisplayString(product.mainBarcode), 1),
						createBaseVNode("td", _hoisted_6$3, toDisplayString(product.requiredQuantity), 1),
						createBaseVNode("td", _hoisted_7$3, [createBaseVNode("div", _hoisted_8$2, [createBaseVNode("button", {
							type: "button",
							class: "pse-action pse-action-quiet",
							title: "Afbeelding tonen",
							onClick: ($event) => onClickShowImage(product.mainBarcode)
							...
							height: "18",
							alt: "Afbeelding"
						}, null, 8, _hoisted_10$2)], 8, _hoisted_9$2)])])
					]);
				}), 128))])])])])], 64);
			};
		}
	}), [["__scopeId", "data-v-d20efe2c"]]);
	...
	var _hoisted_2$3 = { class: "pse-settings-field" };
	var _hoisted_3$2 = ["disabled"];
	var _hoisted_4$2 = ["value"];
	var _hoisted_5$2 = { class: "pse-settings-group" };
	var _hoisted_6$2 = { class: "pse-settings-field" };
	var _hoisted_7$2 = { class: "pse-settings-field" };
					...
					default: withCtx(() => [
						...
						createBaseVNode("div", _hoisted_2$3, [
							...
							withDirectives(createBaseVNode("select", {
								...
								"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => environmentId.value = $event),
								disabled: unref(environmentOptions).length == 0
							}, [_cache[8] || (_cache[8] = createBaseVNode("option", { value: -1 }, "Niet vastgezet (kiezen in de portal)", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(unref(environmentOptions), (option) => {
								return openBlock(), createElementBlock("option", {
									key: option.id,
									value: option.id
								}, toDisplayString(option.name), 9, _hoisted_4$2);
							}), 128))], 8, _hoisted_3$2), [[
								vModelSelect,
								environmentId.value,
								void 0,
							...
							_cache[10] || (_cache[10] = createBaseVNode("small", { class: "pse-dialog-hint" }, " Hoort bij deze computer en de printer erachter. Vastzetten verbergt de keuzelijst in de portal en zet de omgeving bij elke pagina terug. ", -1))
						]),
						createBaseVNode("div", _hoisted_5$2, [
							_cache[13] || (_cache[13] = createBaseVNode("h3", { class: "pse-settings-group-title" }, "Shopware koppeling", -1)),
							createBaseVNode("div", _hoisted_6$2, [_cache[11] || (_cache[11] = createBaseVNode("label", {
								class: "pse-dialog-label",
								for: "pseSwClient"
								...
								name: "pseSwClient",
								class: "pse-dialog-input",
								"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => clientId.value = $event),
								autocomplete: "off",
								spellcheck: "false",
								"data-1p-ignore": "",
								"data-lpignore": "true",
							...
							createBaseVNode("div", _hoisted_7$2, [_cache[12] || (_cache[12] = createBaseVNode("label", {
								class: "pse-dialog-label",
								for: "pseSwSecret"
								...
								"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => clientSecret.value = $event),
								autocomplete: "off",
								spellcheck: "false",
								"data-1p-ignore": "",
								"data-lpignore": "true",
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, { to: __props.to }, [createBaseVNode("div", { class: normalizeClass(["pse-bar", { "is-minimal": __props.minimal }]) }, [
					...
					createBaseVNode("span", _hoisted_7, [_cache[8] || (_cache[8] = createBaseVNode("span", { class: "pse-brand" }, "P&S Extended", -1)), createBaseVNode("span", _hoisted_8, "v" + toDisplayString(unref(package_default).version), 1)]),
					unref(canInstall) ? (openBlock(), createElementBlock("span", _hoisted_9)) : createCommentVNode("", true),
					unref(canInstall) ? (openBlock(), createElementBlock("button", {
						...
						alt: ""
					}, null, 8, _hoisted_10), _cache[9] || (_cache[9] = createBaseVNode("span", { class: "pse-install-label" }, "App installeren", -1))])) : createCommentVNode("", true),
					!__props.minimal ? (openBlock(), createElementBlock("span", _hoisted_11)) : createCommentVNode("", true),
					!__props.minimal ? (openBlock(), createElementBlock("button", {
						key: 6,
						type: "button",
						...
						alt: ""
					}, null, 8, _hoisted_12), _cache[10] || (_cache[10] = createBaseVNode("span", { class: "pse-settings-label" }, "Instellingen", -1))])) : createCommentVNode("", true)
	...
	async function boot() {
		try {
			...
			await domReady();
			if (route?.component && route.attach && !route.anchor) mountApp(route.component, route.attach);
			if (!route?.bareLayout) {
				applyConfiguredEnvironment();
				applyDutchLanguage();
			}
