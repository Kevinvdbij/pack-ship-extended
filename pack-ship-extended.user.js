...
(function() {
	...
	var COMPLETED_HEADING_SELECTOR = "#ReservationContainer h3";
	...
	var _hoisted_13$4 = { class: "pse-cell-barcode" };
				...
				return openBlock(), createElementBlock("article", { class: normalizeClass(["pse-rescard", { "is-incomplete": __props.highlightIncomplete }]) }, [
					...
					__props.showProducts ? (openBlock(), createElementBlock("div", _hoisted_9$8, [createBaseVNode("table", _hoisted_10$8, [_cache[6] || (_cache[6] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: index }, [
							...
							createBaseVNode("td", _hoisted_13$4, toDisplayString(product.barcode), 1),
	...
	var _hoisted_14$3 = { class: "pse-mc-tally-count" };
	var _hoisted_15$3 = { class: "pse-mc-tally-of" };
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("section", { class: normalizeClass(["pse-mc", {
					...
					}, " Start voltooien ")])) : (openBlock(), createElementBlock("div", _hoisted_13$3, [createBaseVNode("span", _hoisted_14$3, [createTextVNode(toDisplayString(settled.value), 1), createBaseVNode("span", _hoisted_15$3, "/" + toDisplayString(__props.amount), 1)]), createBaseVNode("span", _hoisted_16$3, toDisplayString(__props.stopped ? "gestopt" : done.value ? "klaar" : "afgerond"), 1)]))
	...
	var _hoisted_13$2 = { class: "pse-group-count" };
				...
				return openBlock(), createBlock(ModalShell_default, {
					...
					default: withCtx(() => [
						...
						__props.modalData.singleLineReservations.length > 0 ? (openBlock(), createElementBlock("section", _hoisted_10$6, [
							createBaseVNode("header", _hoisted_11$4, [createBaseVNode("h3", _hoisted_12$4, [_cache[7] || (_cache[7] = createTextVNode(" Singleline ", -1)), createBaseVNode("span", _hoisted_13$2, toDisplayString(__props.modalData.singleLineReservations.length), 1)]), _cache[8] || (_cache[8] = createBaseVNode("p", { class: "pse-group-note" }, "Deze reserveringen bevatten 1 stuk van het product.", -1))]),
	...
	var _hoisted_13$1 = { class: "pse-sidebar-value-text" };
				...
				return openBlock(), createElementBlock("aside", _hoisted_1$10, [
					...
					createBaseVNode("div", _hoisted_2$10, [
						...
						createBaseVNode("dl", _hoisted_10$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row) => {
							return openBlock(), createElementBlock(Fragment, { key: row.label }, [createBaseVNode("dt", _hoisted_11$3, toDisplayString(row.label), 1), createBaseVNode("dd", _hoisted_12$3, [createBaseVNode("span", _hoisted_13$1, toDisplayString(row.value), 1), isCopyable(row.label) ? (openBlock(), createElementBlock("button", {
								key: 0,
								type: "button",
								class: normalizeClass(["pse-copy", {
	...
	var _hoisted_13 = { class: "pse-actions" };
				...
				return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, { to: "body" }, [createVNode(Transition, { name: "modal" }, {
					...
					createBaseVNode("div", _hoisted_4$6, [createBaseVNode("table", _hoisted_5$6, [_cache[4] || (_cache[4] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: product.key }, [
							...
							createBaseVNode("td", _hoisted_12$2, [createBaseVNode("div", _hoisted_13, [createBaseVNode("button", {
								type: "button",
								class: "pse-action",
	...
	var _hoisted_4$5 = { class: "pse-done-title" };
	var _hoisted_5$5 = {
		key: 0,
	...
	var CompletedPage_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			function keepPortalDetail(container) {
				const hidden = [];
				const hide = (element) => {
					if (!element || element.classList.contains("pse-portal-replaced")) return;
			...
			function liftCardAboveDetail() {
				...
				if (main && root.value) main.prepend(root.value);
			}
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					createBaseVNode("span", {
						...
						"aria-hidden": "true"
					}, [failed.value ? (openBlock(), createElementBlock("svg", _hoisted_1$7, [..._cache[3] || (_cache[3] = [
					...
					])])) : !finalizing.value ? (openBlock(), createElementBlock("svg", _hoisted_2$7, [..._cache[4] || (_cache[4] = [createBaseVNode("path", { d: "M5 12.5l4.5 4.5L19 7.5" }, null, -1)])])) : (openBlock(), createElementBlock("span", _hoisted_3$5))], 2),
					createBaseVNode("h1", _hoisted_4$5, toDisplayString(failed.value ? heading.value || "Reservering niet verzonden" : "Reservering afgerond"), 1),
					reservationNumber.value ? (openBlock(), createElementBlock("p", _hoisted_5$5, toDisplayString(reservationNumber.value), 1)) : createCommentVNode("", true),
					failed.value ? (openBlock(), createElementBlock("ul", _hoisted_6$4, [(openBlock(true), createElementBlock(Fragment, null, renderList(failures.value, (failure, index) => {
						return openBlock(), createElementBlock("li", {
							class: "pse-done-failure",
							key: index
						}, [failure.step ? (openBlock(), createElementBlock("span", _hoisted_7$4, toDisplayString(failure.step), 1)) : createCommentVNode("", true), failure.detail ? (openBlock(), createElementBlock("span", _hoisted_8$3, toDisplayString(failure.detail), 1)) : createCommentVNode("", true)]);
					}), 128))])) : createCommentVNode("", true),
					failed.value ? (openBlock(), createElementBlock("p", _hoisted_9$3, " De pakketten zijn niet aangemeld. Ga terug naar de pakketten om het opnieuw te proberen. ")) : finalizing.value ? (openBlock(), createElementBlock("p", _hoisted_10$3, " Wordt afgesloten en gaat terug naar zoeken... ")) : (openBlock(), createElementBlock("p", _hoisted_11$1, " De pakketten zijn aangemeld. Sluit de reservering af om verder te gaan. ")),
					failed.value ? (openBlock(), createElementBlock("div", _hoisted_12$1, [parcelsUrl.value ? (openBlock(), createElementBlock("button", {
						key: 0,
						type: "button",
				...
				], 2)], 2)) : createCommentVNode("", true)], 512);
			};
		}
	}), [["__scopeId", "data-v-e9da8418"]]);
