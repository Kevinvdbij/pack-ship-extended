...
(function() {
	...
	var COMPLETED_PARCEL_SELECTOR = "#ReservationContainer .parcels .card";
	var COMPLETED_PARCEL_TITLE_SELECTOR = ".card-title";
	var COMPLETED_PARCEL_FIELD_SELECTOR = ".card-text > div";
	...
	var _hoisted_14$5 = { class: "pse-table-right" };
	var _hoisted_15$5 = {
		key: 1,
				...
				return openBlock(), createElementBlock("article", { class: normalizeClass(["pse-rescard", { "is-incomplete": __props.highlightIncomplete }]) }, [
					...
					__props.showProducts ? (openBlock(), createElementBlock("div", _hoisted_9$8, [createBaseVNode("table", _hoisted_10$8, [_cache[6] || (_cache[6] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: index }, [
							...
							createBaseVNode("td", _hoisted_14$5, [createBaseVNode("span", { class: normalizeClass(["pse-rescard-amount", { "is-short": isShort(product.amount) }]) }, toDisplayString(product.amount), 3)])
						]);
					}), 128))])])])) : createCommentVNode("", true),
					__props.showNote && hasShopwareNote() ? (openBlock(), createElementBlock("div", _hoisted_15$5, [createVNode(ShopwareNote_default, {
	...
	var _hoisted_9$7 = { class: "pse-mc-stepper" };
	var _hoisted_10$7 = ["disabled"];
	var _hoisted_11$5 = ["value"];
	var _hoisted_12$5 = ["disabled"];
	var _hoisted_13$4 = {
		key: 1,
		class: "pse-mc-tally"
	};
	var _hoisted_14$4 = { class: "pse-mc-tally-count" };
	var _hoisted_15$4 = { class: "pse-mc-tally-of" };
	var _hoisted_16$4 = { class: "pse-mc-tally-label" };
	var _hoisted_17$4 = {
		key: 0,
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("section", { class: normalizeClass(["pse-mc", {
					...
					createBaseVNode("div", _hoisted_2$17, [_cache[5] || (_cache[5] = createBaseVNode("h3", { class: "pse-mc-title" }, "Massa voltooien", -1)), !__props.started ? (openBlock(), createElementBlock("p", _hoisted_3$14, " Opent " + toDisplayString(__props.amount) + " van de " + toDisplayString(__props.total) + " reserveringen in de achtergrond en rondt ze af. ", 1)) : !done.value ? (openBlock(), createElementBlock("p", _hoisted_4$13, toDisplayString(settled.value) + " van " + toDisplayString(__props.amount) + " afgerond — laat dit scherm openstaan. ", 1)) : __props.stopped ? (openBlock(), createElementBlock("p", _hoisted_5$13, " Gestopt na een mislukte reservering. " + toDisplayString(__props.finished) + " afgerond, de rest is niet geprobeerd — het tabblad met de fout staat nog open. ", 1)) : __props.failed > 0 ? (openBlock(), createElementBlock("p", _hoisted_6$10, toDisplayString(__props.finished) + " afgerond, " + toDisplayString(__props.failed) + " mislukt. Mislukte reserveringen staan hieronder. ", 1)) : (openBlock(), createElementBlock("p", _hoisted_7$8, " Alle " + toDisplayString(__props.finished) + " reserveringen zijn afgerond. ", 1))]),
					!__props.started ? (openBlock(), createElementBlock("div", _hoisted_8$7, [createBaseVNode("div", _hoisted_9$7, [
					...
					}, " Start voltooien ")])) : (openBlock(), createElementBlock("div", _hoisted_13$4, [createBaseVNode("span", _hoisted_14$4, [createTextVNode(toDisplayString(settled.value), 1), createBaseVNode("span", _hoisted_15$4, "/" + toDisplayString(__props.amount), 1)]), createBaseVNode("span", _hoisted_16$4, toDisplayString(__props.stopped ? "gestopt" : done.value ? "klaar" : "afgerond"), 1)]))
	...
	var _hoisted_14$3 = { class: "pse-rows" };
	var _hoisted_15$3 = {
		key: 1,
		class: "pse-group"
	};
	var _hoisted_16$3 = { class: "pse-group-head" };
				...
				return openBlock(), createBlock(ModalShell_default, {
					...
					default: withCtx(() => [
						...
						__props.modalData.singleLineReservations.length > 0 ? (openBlock(), createElementBlock("section", _hoisted_10$6, [
							...
							createBaseVNode("div", _hoisted_14$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.modalData.singleLineReservations, (reservation) => {
	...
	var _hoisted_17$2 = { class: "pse-sidebar-label" };
	var _hoisted_18$2 = { class: "pse-sidebar-address-body" };
				...
				return openBlock(), createElementBlock("aside", _hoisted_1$10, [
					...
					createBaseVNode("div", _hoisted_2$10, [
						...
						createBaseVNode("dl", _hoisted_10$5, [(openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row) => {
							...
							}, [createBaseVNode("span", _hoisted_15$2, toDisplayString(copyIcon(row.label)), 1)], 10, _hoisted_14$2)) : createCommentVNode("", true)])], 64);
						}), 128))]),
						address.value.length ? (openBlock(), createElementBlock("div", _hoisted_16$2, [createBaseVNode("span", _hoisted_17$2, toDisplayString(addressLabel.value), 1), createBaseVNode("p", _hoisted_18$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(address.value, (line, index) => {
					...
					createBaseVNode("div", _hoisted_4$6, [createBaseVNode("table", _hoisted_5$6, [_cache[4] || (_cache[4] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
						...
						return openBlock(), createElementBlock("tr", { key: product.key }, [
							...
							createBaseVNode("td", _hoisted_12$2, [createBaseVNode("div", _hoisted_13$1, [createBaseVNode("button", {
								...
								height: "18",
								alt: "Toevoegen"
							}, null, 8, _hoisted_15$1)], 8, _hoisted_14$1), createBaseVNode("button", {
								type: "button",
								...
								height: "18",
								alt: "Afbeelding"
							}, null, 8, _hoisted_17$1)], 8, _hoisted_16$1)])])
						]);
					}), 128))])) : (openBlock(), createElementBlock("tbody", _hoisted_18$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(lines.value, (line) => {
	...
	var _hoisted_17 = { class: "pse-done-parcel-name" };
	var _hoisted_18 = {
		key: 0,
	...
	var _hoisted_20 = { class: "pse-done-parcel-amount" };
	var _hoisted_21 = { class: "pse-done-parcel-product" };
	var _hoisted_22 = { class: "pse-done-parcel-product-name" };
	var _hoisted_23 = {
		key: 0,
		class: "pse-done-parcel-barcode"
	};
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					key: 0,
					class: normalizeClass(["pse-done", { "is-failed": failed.value }])
				}, [createBaseVNode("div", _hoisted_1$7, [
					failed.value ? (openBlock(), createElementBlock("aside", _hoisted_2$7, [createVNode(ReservationSidebar_default)])) : createCommentVNode("", true),
					createBaseVNode("div", { class: normalizeClass(["pse-done-card", { "is-failed": failed.value }]) }, [
						...
						createBaseVNode("h1", _hoisted_6$4, toDisplayString(failed.value ? heading.value || "Reservering niet verzonden" : "Reservering afgerond"), 1),
						reservationNumber.value ? (openBlock(), createElementBlock("p", _hoisted_7$4, toDisplayString(reservationNumber.value), 1)) : createCommentVNode("", true),
						failed.value ? (openBlock(), createElementBlock("ul", _hoisted_8$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(failures.value, (failure, index) => {
							return openBlock(), createElementBlock("li", {
								class: "pse-done-failure",
								key: index
							}, [failure.step ? (openBlock(), createElementBlock("span", _hoisted_9$3, toDisplayString(failure.step), 1)) : createCommentVNode("", true), failure.detail ? (openBlock(), createElementBlock("span", _hoisted_10$3, toDisplayString(failure.detail), 1)) : createCommentVNode("", true)]);
						}), 128))])) : createCommentVNode("", true),
						failed.value ? (openBlock(), createElementBlock("p", _hoisted_11$1, " De pakketten zijn niet aangemeld. Ga terug naar de pakketten om het opnieuw te proberen. ")) : finalizing.value ? (openBlock(), createElementBlock("p", _hoisted_12$1, " Wordt afgesloten en gaat terug naar zoeken... ")) : (openBlock(), createElementBlock("p", _hoisted_13, " De pakketten zijn aangemeld. Sluit de reservering af om verder te gaan. ")),
						failed.value ? (openBlock(), createElementBlock("div", _hoisted_14, [parcelsUrl.value ? (openBlock(), createElementBlock("button", {
							key: 0,
							type: "button",
					...
					failed.value ? (openBlock(), createElementBlock("aside", _hoisted_15, [parcels.value.length ? (openBlock(), createElementBlock("section", _hoisted_16, [_cache[5] || (_cache[5] = createBaseVNode("h2", { class: "pse-done-parcels-title" }, "Pakketten", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(parcels.value, (parcel, index) => {
						return openBlock(), createElementBlock("article", {
							class: "pse-done-parcel",
							key: index
						}, [
							createBaseVNode("h3", _hoisted_17, toDisplayString(parcel.title), 1),
							parcel.fields.length ? (openBlock(), createElementBlock("dl", _hoisted_18, [(openBlock(true), createElementBlock(Fragment, null, renderList(parcel.fields, (field) => {
								return openBlock(), createElementBlock(Fragment, { key: field.label }, [createBaseVNode("dt", null, toDisplayString(field.label), 1), createBaseVNode("dd", null, toDisplayString(field.value), 1)], 64);
							}), 128))])) : createCommentVNode("", true),
							parcel.lines.length ? (openBlock(), createElementBlock("ul", _hoisted_19, [(openBlock(true), createElementBlock(Fragment, null, renderList(parcel.lines, (line, lineIndex) => {
								return openBlock(), createElementBlock("li", { key: lineIndex }, [createBaseVNode("span", _hoisted_20, toDisplayString(line.amount) + "×", 1), createBaseVNode("span", _hoisted_21, [createBaseVNode("span", _hoisted_22, toDisplayString(line.name), 1), line.barcode ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(line.barcode), 1)) : createCommentVNode("", true)])]);
							}), 128))])) : createCommentVNode("", true)
						]);
